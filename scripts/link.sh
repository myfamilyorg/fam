...
fam_link() {
    rm -f ${DIRECTORY}/target/src/lib.rs ${DIRECTORY}/target/src/link.c
    cat << EOM >> ${DIRECTORY}/target/src/lib.rs
#![no_std]
...
EOM
    ...
    cat << EOM >> ${DIRECTORY}/target/src/link.c
...
EOM
    ...
    RUSTC_SRC=${DIRECTORY}/target/src
